function labels = ushapelet_wrapper(data, K)
% USHAPELET_WRAPPER is a wrapper function uses the u-shapelet algorithm from
% "u-shapelet" folder to clustering multivariate time series.
%
% INPUT:
%   data      :   N-dim cell
